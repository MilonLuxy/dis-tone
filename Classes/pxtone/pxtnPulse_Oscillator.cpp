...
void pxtnOscillator::ReadyGetSample( pxPOINT *p_point, s32 point_num, s32 volume, s32 sample_num, s32 point_reso )
{
	_volume      = volume    ;
	_p_point     = p_point   ;
...
f64 pxtnOscillator::GetOneSample_Overtone( s32 index )
{
	s32   o;
	f64 work_double;
...
f64 pxtnOscillator::GetOneSample_Coodinate( s32 index )
{
	s32 i;
	s32 c;
	s32 x1, y1, x2, y2;
